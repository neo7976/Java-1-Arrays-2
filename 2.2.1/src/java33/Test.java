    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            switch (Integer.parseInt(inputStr)) {
                ...
                case 90:
//                    setTurn90(colors);
                    printMatrix(setTurn90(colors), "Матрица после поворота на 90:");
                    break;
                case 180:
                    setTurn180(colors);
                    printMatrix(setTurn180(colors), "Матрица после поворота на 180:");
                    break;
                case 270:
                    setTurn270(colors);
                    printMatrix(setTurn270(colors), "Матрица после поворота на 270:");
                    break;
                case 360:
    ...
    public static int[][] setTurn90(int[][] matrixStart) {
        int[][] matrixEnd = new int[SIZE][SIZE];
        for (int i = 0; i < SIZE; i++) {
            for (int j = 0; j < SIZE; j++) {
    ...
    public static int[][] setTurn180(int[][] matrixStart) {
        int[][] matrixEnd = new int[SIZE][SIZE];
        for (int i = 0; i < SIZE; i++) {
            for (int j = 0; j < SIZE; j++) {
    ...
    public static int[][]  setTurn270(int[][] matrixStart) {
        int[][] matrixEnd = new int[SIZE][SIZE];
        for (int i = 0; i < SIZE; i++) {
            for (int j = 0; j < SIZE; j++) {
